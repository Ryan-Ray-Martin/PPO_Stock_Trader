...
class Training(object):
    ...
    def test(self):
        ...
        while True:
            action, state, logits = self.agent.compute_action(obs, prev_action=True, prev_reward=True, state=state)
...
if __name__ == "__main__":
    checkpoint_path = "saves/PPO_2021-04-04_22-57-20/PPO_myEnv_c8d52_00000_0_2021-04-04_22-57-20/checkpoint_25/checkpoint-25"
    training = Training()
    # Train and save 
