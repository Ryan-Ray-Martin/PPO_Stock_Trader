...
class Training(object):
    def __init__(self):
        ...
        self.run = args.run
        self.config_model = es.DEFAULT_CONFIG.copy()
        # Keep it simple.
        self.config_model["env"] = "myEnv" 
        self.config_model["model"]["fcnet_hiddens"] = [64]
        self.config_model["model"]["fcnet_activation"] = None
        self.config_model["noise_size"] = 2500000
        self.config_model["action_noise_std"] = 0.01
        self.config_model["l2_coeff"] = 0.005
        self.config_model["num_workers"] = 1
        #self.config_model["return_proc_mode"] = "centered_rank"
        self.config_model["eval_prob"] = 0.05
        self.config_model["episodes_per_batch"] = 1000
        self.config_model["train_batch_size"] = 10000
        #self.config_model["observation_filter"] = "MeanStdFilter"
        #self.config_model["report_length"] = 10
        self.config_model["eval_prob"] = 0.003
        # Test eval workers ("normal" Trainer eval WorkerSet).
        self.config_model["evaluation_interval"] = 1
        self.config_model["evaluation_num_workers"] = 2
    ...
    def load(self, path):
        ...
        """
        self.agent = ray.rllib.agents.es.ESTrainer(config=self.config_model, env="myEnv")
    ...
    def test(self):
        ...
        print("Sharpe", rewards_data.apply(self.sharpe, freq=252, rfr=0))
...
if __name__ == "__main__":
    checkpoint_path = "saves/ES_2021-03-28_01-47-14/ES_myEnv_31e7b_00000_0_2021-03-28_01-47-15/checkpoint_10/checkpoint-10"
    training = Training()
    # Train and save 
